 ...
 *
 * @author Arsh Gabbi
 * @author Kanush Kumar Arora
 * @author Keshav Jindal
 * @author Neeraj Kumar Sood
 */
...
abstract class Player {
    ...
    protected boolean askFor(Card cType) {
        ...
        Player other = FishGame.Players[tmp];
    ...
    protected void fish() {
        if (FishGame.deckSize() > 0) {
            hand.add(FishGame.draw());
        } else {
...
class AIPlayer extends Player {
    ...
    private Card aiMagic() {
        ...
        return hand.get(FishGame.rng.nextInt(hand.size()));
    }
}
